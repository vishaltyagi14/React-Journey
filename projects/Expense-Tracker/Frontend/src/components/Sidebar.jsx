...
const MENU_ITEMS = [
  ...
  { text: "Income", path: "/income", icon: <ArrowUpCircle size={20} /> },
  { text: "Expenses", path: "/expense", icon: <ArrowDownCircle size={20} /> },
...
const Sidebar = ({ user, isCollapsed, setIsCollapsed }) => {
  ...
  const { name: username = "User", email = "example@domain.com" } = user || {};
  ...
  const toggleSidebar = () => setIsCollapsed((e) => !e);
              ...
              <div className="relative h-full flex flex-col">
                <div className={sidebarStyles.mobileHeader}>
                  <div className={sidebarStyles.mobileUserContainer}>
                    ...
                    <div>
                      <h2 className="text-lg font-bols text-gray-800">
                        {username}
                      </h2>
                ...
                <div className={sidebarStyles.mobileFooter}>
                  <Link to="#" className={sidebarStyles.mobileFooterLink} onClick={()=> setMobileOpen(false)}>
                  <HelpCircle className="text-gray-500" size={20}></HelpCircle>
                  <span>Support</span>
                  </Link>
